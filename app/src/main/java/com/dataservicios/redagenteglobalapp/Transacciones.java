...
/**
 * Created by usuario on 16/02/2015.
 */
public class Transacciones extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyActivity.getActionBar().setTitle("Transacciones");
        ...
        webView.loadUrl("http://redagentesyglobalnet.com/admin/dealingsForAgent/"+id_agente);
