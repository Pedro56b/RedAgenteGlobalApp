...
public class Deuda extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyActivity.getActionBar().setTitle("Deuda");


        Bundle bundle = getIntent().getExtras();
        id_agente = bundle.getString("id");

        WebView webView = (WebView)  findViewById(R.id.wvDeuda);
        ...
        webView.loadUrl("http://redagentesyglobalnet.com/admin/liabilitiesForAgent/"+id_agente);
